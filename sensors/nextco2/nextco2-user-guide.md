...
The NextPM Lite sensor is able to either communicate using a [simple protocol](nextco2-user-guide.md#lzhpfme2ur3) based only on proprietary UART frames or using [Modbus standard ](nextco2-user-guide.md#id-2bn6wsx)protocol. It is also possible to use[ I2C protocol](nextco2-user-guide.md#wq4uaqsn4ee) to communicate with the NextPM Lite.
